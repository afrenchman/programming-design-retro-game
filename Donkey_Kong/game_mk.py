...
LEVEL_PATH = current_dir + "/levels/"          # Levels relative directory
...
def run_mk():
    ...
    #             LOADING GAME IMAGES
    ##################################################
    peach1 = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/peach/peach1.png'),
                                    (2 * section_width, 3 * section_height))
    peach2 = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/peach/peach2.png'),
                                    (2 * section_width, 3 * section_height))
    oil_img = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/OilDrum.png'),
                                    (2 * section_width, 3 * section_height))
    barrel1 = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/barrels/barrel1.png'),
                                        (section_width * 1.5, section_height * 2))
    barrel2 = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/barrels/barrel2.png'),
                                        (section_width * 2, section_height * 2.5))
    barrel_side = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/barrels/barrel2.png'),
                                        (section_width * 2, section_height * 2.5))
    dk1 = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/dk/dk1.png'),
                                (section_width * 5, section_height * 5))
    dk2 = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/dk/dk2.png'),
                                (section_width * 5, section_height * 5))
    dk3 = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/dk/dk3.png'),
                                (section_width * 5, section_height * 5))
    standing = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/mario/standing.png'),
                                    (2 * section_width, 2.5 * section_height))
    standing = pygame.transform.flip(standing,True,False)
    jumping = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/mario/jumping.png'),
                                    (2 * section_width, 2.5 * section_height))
    jumping = pygame.transform.flip(jumping,True,False)
    running = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/mario/running.png'),
                                    (2 * section_width, 2.5 * section_height))
    climbing = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/mario/climbing.png'),
                                    (2 * section_width, 2.5 * section_height))
    hammer_alone = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/Hammer.png'),
                                    (2 * section_width, 2 * section_height))
    hammer_jump = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/mario/hammer_jump.png'),
                                        (2.5 * section_width, 2.5 * section_height))
    hammer_overhead = pygame.transform.scale(pygame.image.load(current_dir + '/assets/images/mario/hammer_overhead.png'),
